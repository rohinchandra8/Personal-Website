  ...
  return (
    <div className="relative group">
      <Link
        ...
        className="text-gray-400 hover:text-gray-700 transition-colors block"
      >
        {children}
      </Link>
      <div className="absolute bottom-full left-1/2 -translate-x-1/2 pb-2 hidden group-hover:block z-10">
        <div className="bg-gray-900 text-white text-xs rounded px-2.5 py-1.5 whitespace-nowrap select-all">
          {tooltip}
        </div>
  ...
  return (
    <footer className="border-t border-gray-200 bg-white">
      <div className="mx-auto max-w-5xl px-6 py-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
        <p className="text-sm text-gray-500">© 2026 Rohin Chandra</p>
